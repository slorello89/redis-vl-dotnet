...
This behavior is covered directly in `tests/RedisVlDotNet.Tests/Indexes/SearchQueryCommandBuilderTests.cs` and in the semantic cache/message history workflows that use vector range matching internally.
