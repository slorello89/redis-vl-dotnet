...
The detailed edge cases live in `tests/RedisVlDotNet.Tests/Caches/SemanticCacheTests.cs` and `tests/RedisVlDotNet.Tests/Caches/SemanticCacheIntegrationTests.cs`.
