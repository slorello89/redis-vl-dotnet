...
* `tests/RedisVlDotNet.Tests/Indexes/SearchQueryCommandBuilderTests.cs` for query-shape and alias normalization
* `tests/RedisVlDotNet.Tests/Indexes/SearchIndexAsyncTests.cs` for aggregate execution and batching
* `tests/RedisVlDotNet.Tests/Queries/SearchResultMappingTests.cs` for typed row mapping failures and successes
