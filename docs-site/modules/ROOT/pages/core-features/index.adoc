...
| xref:core-features/hybrid-search-query.adoc[`HybridSearchQuery`]
| Native `FT.HYBRID` search (Redis 8.4+) with server-side score fusion (linear weighting or reciprocal rank fusion).
