...
The contract details are also covered in `tests/RedisVlDotNet.Tests/Workflows/SemanticRouterTests.cs` and `tests/RedisVlDotNet.Tests/Workflows/SemanticRouterIntegrationTests.cs`.
